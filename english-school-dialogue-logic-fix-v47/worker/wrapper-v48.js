  ...
  async fetch(request, env, ctx) {
    ...
    return new HTMLRewriter()
      .on('head', {
        element(element) {
          element.append(
            '<link rel="stylesheet" href="/assets/fix-v48.css?v=48">' +
            '<link rel="stylesheet" href="/assets/transparent-dialogs-v48.css?v=48.1">' +
            '<script defer src="/assets/runtime-v48.js?v=48.1"></script>',
            { html: true }
          );
        }
      })
